...
//        if(mHolder.mOffsetY!=0)return;
        LogUtils.debugInfo("onLayout mHolder.mOffsetY=" + mHolder.mOffsetY);
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                LogUtils.debugInfo("isTop=" + mContentView.isTop() + ";isBottom=" + mContentView.isBottom());
    ...
    private void sendCancelEvent() {
        if (!mHasSendCancelEvent) {
            LogUtils.debugInfo("sendCancelEvent");
            setRefreshTime();
    ...
    private void sendDownEvent() {
        if (!mHasSendDownEvent) {
            LogUtils.debugInfo("sendDownEvent");
            mHasSendCancelEvent = false;
    ...
    private void resetHeaderHeight() {
        ...
        LogUtils.debugInfo("resetHeaderHeight offsetY=" + offsetY);
    }
...
//            headerMovePercent = headerMovePercent > 1 ? 1 : headerMovePercent;
    ...
    public void stopRefresh(boolean success) {
        LogUtils.debugInfo("stopRefresh mPullRefreshing=" + mPullRefreshing);
    ...
    private Runnable mRunnable = new Runnable() {
        ...
        public void run() {
            if (mScroller.computeScrollOffset()) {
                ...
                LogUtils.debugInfo("currentY=" + currentY + ";mHolder.mOffsetY=" + mHolder.mOffsetY);
