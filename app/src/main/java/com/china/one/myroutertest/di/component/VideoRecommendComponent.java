...
@FragmentScope
@Component(modules = VideoRecommendModule.class, dependencies = AppComponent.class)
public interface VideoRecommendComponent {
    void inject(VideoRecommendFragment activity);
}